...
public class TestVisit {
  ...
  return (Integer )alg.Method(alg.Seq(alg.Visit(alg.Exp(() -> { return e; }), java.util.Arrays.asList(alg.When((Var x) -> { return alg.ExpStat(alg.Exp(() -> { return n += 1; })); }))), alg.Return(alg.Exp(() -> { return n; }))));
}
